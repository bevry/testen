...
<span class="badge-travisci"><a href="http://travis-ci.org/bevry/testen" title="Check this project's build status on TravisCI"><img src="https://img.shields.io/travis/bevry/testen/master.svg" alt="Travis CI Build Status" /></a></span>
...
<li>Executable: <code>@bevry/testen</code></li></ul>
...
<li><code>@bevry/testen/source/index.js</code> is Source + <a href="https://babeljs.io/docs/learn-es2015/" title="ECMAScript Next">ESNext</a> + <a href="https://nodejs.org/dist/latest-v5.x/docs/api/modules.html" title="Node/CJS Modules">Require</a></li></ul>
...
<ul><li><a href="http://egoist.moe/hi">EGOIST</a> — <a href="https://github.com/bevry/testen/commits?author=egoist" title="View the GitHub contributions of EGOIST on repository bevry/testen">view contributions</a></li>
...
<ul><li>Copyright &copy; 2016-2017 <a href="http://egoist.moe/hi">EGOIST</a></li>
